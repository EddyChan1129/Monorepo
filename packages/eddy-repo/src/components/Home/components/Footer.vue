...
const footer = reactive([
  {
    info: '首页',
    img: 'src/assets/footer/home.png',
    imgActive: 'src/assets/footer/active/home.png',
    path: '/',
  },
  {
    info: '开奖',
    img: 'src/assets/footer/lucky.png',
    imgActive: 'src/assets/footer/active/lucky.png',
    path: '/lucky',
  },
  {
    info: '游戏',
    img: 'src/assets/footer/game.png',
    imgActive: 'src/assets/footer/active/game.png',
    path: '/game',
  },
  {
    info: '活动',
    img: 'src/assets/footer/event.png',
    imgActive: 'src/assets/footer/active/event.png',
    path: '/event',
  },
  {
    info: '我的',
    img: 'src/assets/footer/me.png',
    imgActive: 'src/assets/footer/active/me.png',
    path: '/dashboard',
  },
]);
